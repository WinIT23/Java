// an try this. I have created this to see who is using my wifi illegally :) .
// Hope it’ll help :)
        ...
        if(myip.equals("127.0.0.1")){
            ...
            for(int i=1;i<=254;++i){
                try {
                    ...
                    if (addr.isReachable(10)){ // See if it is reachable or simply available(check time is 1s=1000ms)
